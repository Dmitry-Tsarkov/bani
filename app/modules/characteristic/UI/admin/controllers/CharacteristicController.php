...
namespace app\modules\characteristic\UI\admin\controllers;
...
//        $characteristic = Characteristic::getOrFail($id);
//
//        $searchModels = new VariantSearch($characteristic);
//        $dataProvider = $searchModels->search(\Yii::$app->request->get());
//
//        return $this->render('variant', compact('dataProvider', 'searchModels', 'characteristic'));
//    }
