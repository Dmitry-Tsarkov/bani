...
if(Yii::$app->controller->action->id == 'update') {
    ...
    $this->params['breadcrumbs'][] = [
        'label' => $this->title,
        'url' => ['/page/category/update', 'id' => $page->id]
    ];
}
...
<div class="nav-tabs-custom">
    <?= Tabs::widget([
        'items' => array_filter([
            [
                'label' => 'Общее',
                'url' => ['/page/category/default/update', 'id' => $page->id],
                'active' => Yii::$app->controller->action->id == 'update',
            ],
            [
                'label' => 'SEO',
                'url' => ['/page/category/default/seo', 'id' => $page->id],
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'url' => ['/page/category/default/delete', 'id' => $page->id],
                        'linkOptions' => [
                            'class' => 'text-danger',
                            'data-method' => 'post',
