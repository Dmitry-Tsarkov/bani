      ...
      .form-order__content
        ...
        .form-order__grid
          .form-order__item
            ...
            input.form-order__input(type='text' placeholder='Иванов Иван Иванович' v-model="form.name" :class='{ error: errors.name }')
            span.error(v-if='errors.name') {{ errors.name }}
          .form-order__item
            p.form-order__title E-mail
            input.form-order__input(type='email' placeholder='example@mail.ru' v-model="form.email" :class='{ error: errors.email }')
